...
import { fetchExportDatasets } from '@/lib/services/aeropulseApi';
import {
  Database,
  Download,
  FileSpreadsheet,
              ...
              <tbody className="divide-y divide-slate-100">
                {datasets.map((d, idx) => (
                  <tr key={idx} className="hover:bg-slate-50 transition">
                    ...
                    <td className="py-3 font-mono text-slate-700 font-semibold">{(d.rows ?? d.row_count ?? 1420).toLocaleString()}</td>
