...
import { submitLifestyleSurvey } from '@/lib/services/aeropulseApi';
import {
  UserCheck,
  CheckCircle2,
  ArrowRight,
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-12">
      ...
      {isSurveyMode ? (
        ...
        <div className="classy-card rounded-3xl p-12 text-center space-y-4">
          <h3 className="text-xl font-bold text-slate-800">No Assessment Recorded Yet</h3>
          <p className="text-sm text-slate-500 max-w-md mx-auto">
            Take the 5-step lifestyle assessment to compute your personal exposure score and green footprint metrics.
          </p>
          <button
            onClick={() => setIsSurveyMode(true)}
            className="px-6 py-2.5 rounded-xl bg-slate-900 text-white text-xs font-bold shadow-md hover:bg-slate-800 transition"
          >
